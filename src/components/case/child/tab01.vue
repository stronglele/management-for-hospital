// 入院诊断
<template>
  <div id="tab01" class="caseform-wrapper">
...
<script>
  ...
  export default {
    ...
    created () {
      ...
      this.$http.get(`${this.$global.api}admissionDiagnosis/get?illnessId=${this.$route.params.id}&time=${new Date().getTime()}`)
        .then(res => {
...
//        console.log(this.form)
        this.$http.post(`${this.$global.api}admissionDiagnosis/save`, this.form)
          .then(res => {
